...
public class ByteBufferTest {
    public static void main(String[] args) {
        simpleUse();
//        System.out.println(getUnsignedInt(-1));
//        String text = "p3342,，SPZ$";
//        String name = text.replaceAll("[\\pP\\pS\\pZ]", "");
//        System.out.println(name);
//        System.out.println(Math.pow(2,64L));
    }

    public static long getUnsignedInt(int index) {
    ...
    private static void simpleUse(){
        ...
        System.out.println("test:"+buf.getUnsignedInt(2)+" | " + buf.getInt(2)+"|" );
        ...
        buf.setIndex(3,4);
        System.out.println("xxxx:"+buf.readByte());
